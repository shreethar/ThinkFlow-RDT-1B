...
export SMOLVLA_QWEN_EVAL_LATENT_PRECISION=${SMOLVLA_QWEN_EVAL_LATENT_PRECISION:-bf16}
export SMOLVLA_QWEN_EVAL_QWEN_DEVICE_MAP=${SMOLVLA_QWEN_EVAL_QWEN_DEVICE_MAP:-cuda}
